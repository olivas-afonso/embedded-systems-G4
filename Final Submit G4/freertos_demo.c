...
main(void)
{
    ...
    // Create the Queues
    Lcd_Write_Queue = xQueueCreate(20, sizeof(lcd_packet));
    Menu_Control_Queue = xQueueCreate(20, sizeof(char));
    UART_Buffer_Queue = xQueueCreate(20, sizeof(char[50]));
    Menu_Buffer_Queue = xQueueCreate(20, sizeof(buffer_packet));
