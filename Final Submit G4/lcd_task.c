...
LCD_Task(void *pvParameters)
{
    ...
    while(1)
    {
        ...
        switch(data_in.identifier)
        {
            ...
            case MENU_STARTUP: //Print wait for start button
                Lcd_Clear();
                vTaskDelay(10/portTICK_RATE_MS);
            ...
            case MENU_COLD_START: //Print day format
                Lcd_Clear();
                vTaskDelay(10/portTICK_RATE_MS);
            ...
            case MENU_WAIT_POSITION://Print time format
                Lcd_Clear();
                vTaskDelay(10/portTICK_RATE_MS);
                Lcd_Write_String("Buffer Position");
                vTaskDelay(10/portTICK_RATE_MS);
                break;
